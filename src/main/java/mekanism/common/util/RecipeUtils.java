...
public class RecipeUtils {
    ...
    private static boolean isFactory(ItemStack stack) {
        ...
        return type == BlockStateMachine.MachineType.BASIC_FACTORY
              || type == BlockStateMachine.MachineType.ADVANCED_FACTORY
              || type == BlockStateMachine.MachineType.ELITE_FACTORY;
    }
